<%@ Page Title="客訴內容" Language="C#" MasterPageFile="~/Site_S_UI.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="myCustComplaint_Edit" %>
    ...
    <div class="myContentBody">
                    ...
                    <div class="ui attached segment grey-bg lighten-5">
                        ...
                        <div class="ui segments">
                            ...
                            <div class="ui small form segment">
                                    ...
                                    <div class="eight wide field">
                                        <div class="fields">
                                            <div class="sixteen wide field">
                                                <label>處理方式</label>
                                                <asp:DropDownList ID="ddl_Flow201_Type" runat="server">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="field">
                                            <label>客訴判斷說明</label>
                                            <asp:TextBox ID="tb_Remark_Check" runat="server" MaxLength="200" TextMode="MultiLine" Rows="4"></asp:TextBox>
                                        </div>
                                    </div>
                                    <!-- Right Block -->
                                    <div class="eight wide field">
                                        <div class="fields">
                                            <div class="sixteen wide field">
                                                <label>處理說明</label>
                                                <asp:TextBox ID="tb_Flow201_Desc" runat="server" MaxLength="2000" TextMode="MultiLine" Rows="5"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="fields">
                                ...
                                <asp:PlaceHolder ID="ph_tip201" runat="server">
                                    <div class="ui grid">
                                        <div class="column right aligned">
                                            <div class="ui top pointing blue basic large label"><i class="edit icon"></i>請填寫資料</div>
                                        </div>
                                    </div>
                                </asp:PlaceHolder>
                            </div>
                            ...
                            <div class="ui small form segment">
                                <div class="fields">
                                    ...
                                    <div class="eight wide field">
                                        <div class="fields">
                                            <div class="sixteen wide field">
                                                <label>處理方式</label>
                                                <asp:DropDownList ID="ddl_Flow301_Type" runat="server">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="fields">
                                            <div class="six wide field">
                                                ...
                                                <div class="ui left icon input datepicker">
                                                    <asp:TextBox ID="tb_FixWishDate" runat="server" MaxLength="10" autocomplete="off" placeholder="格式:西元年/月/日"></asp:TextBox>
                                            ...
                                            <div class="six wide field">
                                                <label>維修完成日</label>
                                                <div class="ui left icon input datepicker">
                                                    <asp:TextBox ID="tb_FixOkDate" runat="server" MaxLength="10" autocomplete="off" placeholder="格式:西元年/月/日"></asp:TextBox>
                                    ...
                                    <div class="eight wide field">
                                        <div class="fields">
                                            <div class="sixteen wide field">
                                                <label>處理說明</label>
                                                <asp:TextBox ID="tb_Flow301_Desc" runat="server" MaxLength="2000" TextMode="MultiLine" Rows="5"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="fields">
                                            <div class="seven wide field grey-text text-darken-2">
                                ...
                                <asp:PlaceHolder ID="ph_tip301" runat="server">
                                    <div class="ui grid">
                                        <div class="column right aligned">
                                            <div class="ui top pointing blue basic large label"><i class="edit icon"></i>請填寫資料</div>
                                        </div>
                            ...
                            <div class="ui small form segment">
                                ...
                                <asp:PlaceHolder ID="ph_tip401" runat="server">
                                    <div class="ui grid">
                                        <div class="column right aligned">
                                            <div class="ui top pointing blue basic large label"><i class="edit icon"></i>請填寫資料</div>
                                        </div>
                            ...
                            <div class="ui small form segment">
                                <div class="fields">
                                    ...
                                    <div class="eight wide field">
                                        <div class="fields">
                                            <div class="sixteen wide field">
                                                <label>處理方式</label>
                                                <asp:DropDownList ID="ddl_Flow501_Type" runat="server">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="fields">
                                            <div class="sixteen wide field">
                                                <label>物流快遞公司</label>
                                                <asp:TextBox ID="tb_ShipComp" runat="server" MaxLength="40"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="two fields">
                                            <div class="field">
                                                <label>物流快遞單號</label>
                                                <asp:TextBox ID="tb_ShipNo" runat="server" MaxLength="20"></asp:TextBox>
                                            </div>
                                            <div class="field">
                                                <label>寄(取)貨日</label>
                                                <div class="ui left icon input datepicker">
                                                    <asp:TextBox ID="tb_ShipDate" runat="server" MaxLength="10" autocomplete="off" placeholder="格式:西元年/月/日"></asp:TextBox>
                                                    <i class="calendar alternate outline icon"></i>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="eight wide field">
                                        <div class="fields">
                                            <div class="sixteen wide field">
                                                <label>處理說明</label>
                                                <asp:TextBox ID="tb_Flow501_Desc" runat="server" MaxLength="2000" TextMode="MultiLine" Rows="5"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="fields">
                                            <div class="seven wide field grey-text text-darken-2">
                                ...
                                <asp:PlaceHolder ID="ph_tip501" runat="server">
                                    <div class="ui grid">
                                        <div class="column right aligned">
                                            <div class="ui top pointing blue basic large label"><i class="edit icon"></i>請填寫資料</div>
                                        </div>
                    ...
                    <div class="ui sticky">
                        ...
                        <div class="ui vertical text menu">
                            ...
                            <div class="item">
                                ...
                                <asp:HiddenField ID="hf_FlowStatus" runat="server" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="tipPage" class="ui modal">
            ...
            <div class="content">
                ...
                <ul class="ui list">
                    <li><span>返回列表</span>：前往客訴清單.</li>
                    <li><span class="green-text">資料存檔</span>：僅儲存資料.</li>
                    <li><span class="orange-text">派送下關</span>：儲存資料後,將流程派送至下一關,並發信通知該關卡人員.</li>
                </ul>
            </div>
            <div class="actions">
