<%@ Page Title="每日(編輯)" Language="C#" MasterPageFile="~/Site_S_UI.master" AutoEventWireup="true" CodeFile="EditByDay.aspx.cs" Inherits="myECdata_SH_EditByDay" %>
            ...
            <div class="ui segments">
                ...
                <div class="ui small form segment">
                    <div class="fields">
                        <div class="eight wide field">
                            ...
                            <div class="ui left icon input datepicker">
                                <asp:TextBox ID="tb_setDate" runat="server" autocomplete="off"></asp:TextBox>
                    ...
                    <div class="four fields">
                        <div class="field">
                            <label>平台參考銷售金額</label>
                            <asp:TextBox ID="tb_Price_RefSales" runat="server" MaxLength="10" placeholder="" autocomplete="off" type="number" step="any">0</asp:TextBox>
                        </div>
                        <div class="field">
                            <label>平台參考毛利 (%)</label>
                            <asp:TextBox ID="tb_Price_RefProfit" runat="server" MaxLength="10" placeholder="" autocomplete="off" type="number" step="any">0</asp:TextBox>
                        </div>
                        <div class="field">
                            <label>ERP銷售淨額</label>
                            <asp:TextBox ID="tb_Price_RealSales" runat="server" MaxLength="10" placeholder="" autocomplete="off" type="number" step="any">0</asp:TextBox>
                        </div>
                        <div class="field">
                            <label>ERP毛利率 (%)</label>
                            <asp:TextBox ID="tb_Price_RealProfit" runat="server" MaxLength="10" placeholder="" autocomplete="off" type="number" step="any">0</asp:TextBox>
                        </div>
                    </div>
                    <div class="four fields">
                        <div class="field">
                            <label>總訂單金額</label>
                            <asp:TextBox ID="tb_Price_OrderPrice" runat="server" MaxLength="10" placeholder="" autocomplete="off" type="number" step="any">0</asp:TextBox>
                        </div>
                        <div class="field">
                            <label>ROI</label>
                            <asp:TextBox ID="tb_Price_ROI" runat="server" MaxLength="10" placeholder="" autocomplete="off" type="number" step="any">0</asp:TextBox>
                        </div>
                        <div class="field">
                            <label>平均點擊成本</label>
                            <asp:TextBox ID="tb_Price_ClickCost" runat="server" MaxLength="10" placeholder="" autocomplete="off" type="number" step="any">0</asp:TextBox>
                        </div>
                        <div class="field">
                        </div>
                    </div>
                    <div class="four fields">
                        <div class="field">
                            <label>京快車.海投 投放費 (A)</label>
                            <asp:TextBox ID="tb_Price_Adv1" runat="server" MaxLength="10" placeholder="" autocomplete="off" type="number" step="any">0</asp:TextBox>
                        </div>
                        <div class="field">
                            <label>京挑客投放費 (B)</label>
                            <asp:TextBox ID="tb_Price_Adv2" runat="server" MaxLength="10" placeholder="" autocomplete="off" type="number" step="any">0</asp:TextBox>
                        </div>
                        <div class="field">
                            <label>其他 (C)</label>
                            <asp:TextBox ID="tb_Price_Adv3" runat="server" MaxLength="10" placeholder="" autocomplete="off" type="number" step="any">0</asp:TextBox>
                        </div>
                        <div class="field">
                        </div>
                    </div>
                    <div class="ui two column grid">
                        ...
                        <div class="column right aligned">
                            <asp:PlaceHolder ID="ph_AddNext" runat="server" Visible="false">
                                <a href="<%=FuncPath() %>/Date/Edit" class="ui blue small button">新增下一筆</a>
                            </asp:PlaceHolder>
