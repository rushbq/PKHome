...
public partial class myECdata_SH_ImportPrice : SecurityCheck
{
    //設定FTP連線參數
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
             ...
             */
            bool isPass = false;
            isPass = fn_CheckAuth.Check(fn_Param.CurrentUser, "3809");
    ...
    public string thisPage
    {
        get
        {
            return "{0}myECdata_SH/ImportPrice.aspx".FormatThis(fn_Param.WebUrl);
        }
        set
        {
            _thisPage = value;
    ...
    public string UploadFolder
    {
        get
        {
            return "{0}ecData/".FormatThis(System.Web.Configuration.WebConfigurationManager.AppSettings["File_Folder"]);
        }
        set
        {
            _UploadFolder = value;
