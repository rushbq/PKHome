<%@ Page Title="年度" Language="C#" MasterPageFile="~/Site_S_UI.master" AutoEventWireup="true" CodeFile="SearchByDate.aspx.cs" Inherits="myECdata_SH_SearchByDate" %>
    ...
    <div class="myContentBody">
        ...
        <asp:PlaceHolder ID="ph_EmptyData" runat="server" Visible="false">
            <div class="ui secondary pointing menu">
                <%if (Req_TypeID.Equals("1"))
                    { %>
                <a class="item" href="<%=FuncPath() %>/Year">年度</a>
                <%} %>
                <a class="item" href="<%=FuncPath() %>/Month">每月
                </a>
                <a class="item active" href="<%=thisPage %>">每日
                </a>
            </div>
                ...
                <asp:ListView ID="lvDataList" runat="server" ItemPlaceholderID="ph_Items" OnItemCommand="lvDataList_ItemCommand" OnItemDataBound="lvDataList_ItemDataBound">
                        ...
                        <table class="ui celled selectable compact small table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="right aligned">參考銷售金額</th>
                                    <th class="right aligned">參考毛利</th>
                                    <th class="right aligned">ERP銷售淨額</th>
                                    <th class="right aligned">ERP毛利率</th>
                                    <th class="right aligned">總訂單金額</th>
                                    <th class="right aligned">ROI</th>
                                    <th class="right aligned">平均點擊成本</th>
                                    <th class="right aligned">京快車.海投 投放費</th>
                                    <th class="right aligned">京挑客投放費</th>
                                    <th class="right aligned">其他</th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td class="right aligned">
                                <%#Eval("Price_RefProfit") %>
                            </td>
                            <td class="right aligned">
                                <%#Eval("Price_RealSales") %>
                            </td>
                            <td class="right aligned">
                                <%#Eval("Price_RealProfit") %>
                            </td>
                            <td class="right aligned">
                                <%#Eval("Price_OrderPrice") %>
                            </td>
                            <td class="right aligned">
                                <%#Eval("Price_ROI") %>
                            </td>
                            <td class="right aligned">
                                <%#Eval("Price_ClickCost") %>
                            </td>
                            <td class="right aligned">
                                <%#Eval("Price_Adv1") %>
                            </td>
