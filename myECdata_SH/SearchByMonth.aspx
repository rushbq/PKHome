<%@ Page Title="每月" Language="C#" MasterPageFile="~/Site_S_UI.master" AutoEventWireup="true" CodeFile="SearchByMonth.aspx.cs" Inherits="myECdata_SH_SearchByMonth" %>
    ...
    <div class="myContentBody">
        ...
        <asp:PlaceHolder ID="ph_EmptyData" runat="server" Visible="false">
            <div class="ui secondary pointing menu">
                ...
                <%} %>
                <a class="item active" href="<%=thisPage%>">每月
                </a>
                        ...
                        <table class="ui celled selectable compact small table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="center aligned">月份</th>
                                    <th class="center aligned">平台</th>
                                    <th class="right aligned">平台收入</th>
                                    <th class="right aligned">銷售返利</th>
                                    <th class="right aligned">成本每月</th>
                                    <th class="right aligned">毛利保護</th>
                                    <th class="right aligned">採購金額</th>
                                    <th class="right aligned">退貨金額</th>
