...
public partial class myECdata_SH_SearchByMonth : SecurityCheck
{
            ...
            if (!IsPostBack)
            {
                ...
                */
                ...
                switch (Req_TypeID)
                {
                    case "1":
                        //工具
                        isPass = fn_CheckAuth.Check(fn_Param.CurrentUser, "3803");
                        break;

                    default:
                        //科玩
                        isPass = fn_CheckAuth.Check(fn_Param.CurrentUser, "3807");
                        break;
                }
