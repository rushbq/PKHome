<%@ Page Title="銷售數量匯入(深圳)" Language="C#" MasterPageFile="~/Site_S_UI.master" AutoEventWireup="true" CodeFile="ImportSaleAmt.aspx.cs" Inherits="myECdata_SZ_ImportSaleAmt" %>
            ...
            <div class="ui segments">
                ...
                <div class="ui small form segment">
                    <div class="fields">
                        <div class="two wide field">
                            <label>年</label>
                            <asp:DropDownList ID="ddl_Year1" runat="server" CssClass="fluid">
                            </asp:DropDownList>
                        </div>
                        <div class="two wide field">
                            <label>月</label>
                            <asp:DropDownList ID="ddl_Month1" runat="server" CssClass="fluid">
                            </asp:DropDownList>
                        </div>
                        ...
                        <div class="eight wide field">
                            <label>選擇Excel檔&nbsp;<a href="<%=fn_Param.CDNUrl %>PKHome/eCommerceData/Import_SalesAmount.xlsx" target="_blank">(範本下載)</a></label>
                ...
                <div class="ui small form segment">
                    <div class="fields">
                        <div class="two wide field">
                            <label>年</label>
                            <asp:DropDownList ID="ddl_Year2" runat="server" CssClass="fluid">
                            </asp:DropDownList>
                        </div>
                        <div class="two wide field">
                            <label>月</label>
                            <asp:DropDownList ID="ddl_Month2" runat="server" CssClass="fluid">
                            </asp:DropDownList>
                        </div>
                        <div class="four wide field">
                            <label>選擇平台</label>
