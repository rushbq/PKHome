...
public partial class myECdata_SZ_ImportSaleAmt : SecurityCheck
{
    //設定FTP連線參數
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
             ...
             */
            bool isPass = false;
            isPass = fn_CheckAuth.Check(fn_Param.CurrentUser, "3751");
    ...
    public string thisPage
    {
        get
        {
            return "{0}myECdata_SZ/ImportSaleAmt.aspx".FormatThis(fn_Param.WebUrl);
        }
        set
        {
            _thisPage = value;
