<%@ Page Title="客戶備註內容" Language="C#" MasterPageFile="~/Site_S_UI.master" AutoEventWireup="true" CodeFile="CustEdit.aspx.cs" Inherits="myOpcsRemark_CustEdit" %>
                    ...
                    <div class="ui attached segment grey-bg lighten-5">
                        ...
                        <div class="ui segments">
                            ...
                            <div class="ui form segment">
                                ...
                                <div class="field">
                                    <label>2210備註</label>
                                    <asp:TextBox ID="tb_Remk_2210" runat="server" MaxLength="200" TextMode="MultiLine" Rows="10"></asp:TextBox>
                                </div>
                            ...
                            <div class="ui segment">
                                ...
                                <asp:ListView ID="lv_Attachment" runat="server" ItemPlaceholderID="ph_Items" OnItemCommand="lv_Attachment_ItemCommand">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                                <a href="<%#fn_Param.RefUrl %><%#UploadFolder %><%:Req_DBS %>/<%=hf_CustID.Value %>/<%#Eval("AttachFile") %>" target="_blank"><%#Eval("AttachFile_Org") %></a>
                                            </td>
