    ...
    <form id="form1" runat="server">
        <div width="1085">
            <div style="text-align: center;">
                <h4>
                    <asp:Literal ID="lt_CompName" runat="server"></asp:Literal>
                </h4>
                <h5>
                    <asp:Literal ID="lt_OrderTypeName" runat="server"></asp:Literal>
                </h5>
            </div>
            <table width="100%" border="1" style="border-collapse: collapse;">
                <thead>
                    <tr>
                        <td width="285" height="40" colspan="4">核單日期：
                            <asp:Literal ID="lt_CheckDate" runat="server"></asp:Literal>
                        </td>
                        <td width="355" colspan="6">接單日期：
                            <asp:Literal ID="lt_OrderDate" runat="server"></asp:Literal>
                        </td>
                        <td width="445" colspan="4">訂單編號：
                ...
                <asp:ListView ID="lvDataList_TW" runat="server" ItemPlaceholderID="ph_Items" Visible="false">
                    <LayoutTemplate>
                        <tr>
                            <td width="45" style="text-align: center;">序號</td>
                            <td width="120">產品編號</td>
                            <td width="60" style="text-align: right">訂購<br />數量</td>
                            <td width="60" style="text-align: right">贈品量</td>
                            <td width="45" style="text-align: right">現有<br />
                                庫存</td>
                            <td width="45" style="text-align: center">庫別</td>
                            <td width="90">廠商<br />
                                簡稱</td>
                            <td width="60">採購單<br />
                                編號</td>
                            ...
                            <td width="65">箱號</td>
                            <td width="80">客戶品號</td>
                            <td width="150">條碼編號</td>
                            <td width="150">客戶產品特別<br />
                                注意事項</td>
                        </tr>
                        <tbody>
                ...
                <asp:ListView ID="lvDataList_SH" runat="server" ItemPlaceholderID="ph_Items" Visible="false">
                    <LayoutTemplate>
                        <tr>
                            ...
                            <td width="45" style="text-align: right">現有<br />
                                庫存</td>
                            <td width="45" style="text-align: right">已訂<br />
                                未交</td>
                            <td width="45" style="text-align: right">採購<br />
                                未進</td>
                            <td width="90">廠商<br />
                                簡稱</td>
                            <td width="60">採購單<br />
