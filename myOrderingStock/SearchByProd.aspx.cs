...
public partial class myOrderingStock_SearchByProd : SecurityCheck
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                 ...
                 * 取得其他權限
                 */
                bool isPass = fn_CheckAuth.Check(fn_Param.CurrentUser, "3765");
                ...
                //[產生選單]
                Get_ClassList(filter_Class, "所有資料");
    ...
    protected void btn_Excel_Click(object sender, EventArgs e)
    {
        ...
        if (myDT.Rows.Count > 0)
        {
            ...
            myDT.Columns["StockQty_23"].SetOrdinal(22);
            myDT.Columns["PreSell_23"].SetOrdinal(23);
            myDT.Columns["PreIN_23"].SetOrdinal(24);
            myDT.Columns["PreSet_23"].SetOrdinal(25);
            myDT.Columns["PreGet_23"].SetOrdinal(26);
            myDT.Columns["StockQty_12"].SetOrdinal(27);
            myDT.Columns["PreSell_12"].SetOrdinal(28);
            myDT.Columns["PreIN_12"].SetOrdinal(29);
            myDT.Columns["PreSet_12"].SetOrdinal(30);
            myDT.Columns["PreGet_12"].SetOrdinal(31);
            myDT.Columns["StockQty_128"].SetOrdinal(32);
            myDT.Columns["PreSell_128"].SetOrdinal(33);
            myDT.Columns["PreIN_128"].SetOrdinal(34);
            myDT.Columns["PreSet_128"].SetOrdinal(35);
            myDT.Columns["PreGet_128"].SetOrdinal(36);
            myDT.Columns["StockQty_A01"].SetOrdinal(37);
            myDT.Columns["PreSell_A01"].SetOrdinal(38);
            myDT.Columns["PreIN_A01"].SetOrdinal(39);
            myDT.Columns["PreSet_A01"].SetOrdinal(40);
            myDT.Columns["PreGet_A01"].SetOrdinal(41);
            myDT.Columns["SZ_StockQty_A01"].SetOrdinal(42);
            myDT.Columns["SZ_PreSell_A01"].SetOrdinal(43);
            myDT.Columns["SZ_PreIN_A01"].SetOrdinal(44);
            myDT.Columns["SZ_PreSet_A01"].SetOrdinal(45);
            myDT.Columns["SZ_PreGet_A01"].SetOrdinal(46);
            myDT.Columns["Class_ID"].SetOrdinal(47);
            ...
            myDT.Columns["StockQty_23"].ColumnName = "23庫存(台灣)";
            myDT.Columns["PreSell_23"].ColumnName = "23預計銷";
            myDT.Columns["PreIN_23"].ColumnName = "23預計進";
            myDT.Columns["PreSet_23"].ColumnName = "23預計生";
            myDT.Columns["PreGet_23"].ColumnName = "23預計領";
    ...
    private void Get_ClassList(DropDownList ddl, string rootName)
    {
        //----- 宣告:資料參數 -----
        Menu3000Repository _data = new Menu3000Repository();

        //----- 原始資料:取得所有資料 -----
        var query = _data.GetProdClass(Req_Lang, out ErrMsg);
        ...
        {
            string fullLabel = item.ID + " - " + item.Label;
