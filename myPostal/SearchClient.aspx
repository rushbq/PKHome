<%@ Page Title="郵件寄送登記" Language="C#" MasterPageFile="~/Site_S_UI.master" AutoEventWireup="true" CodeFile="SearchClient.aspx.cs" Inherits="myPostal_SearchClient" %>
        ...
        <div class="ui small menu toolbar">
            <div class="item">
                <div class="ui small breadcrumb">
                    ...
                    <h5 class="active section red-text text-darken-2">郵件寄送登記
                    </h5>
                </div>
            </div>
        </div>
                        ...
                        <div class="content">
                            <div id="formBase" class="ui small form">
                                <div class="fields">
                                    ...
                                    <div class="four wide required field">
                                        <label>日期</label>
                                        <asp:PlaceHolder ID="ph_date" runat="server">
                                            <div class="ui left icon input datepicker-edit">
                                                <asp:TextBox ID="tb_PostDate" runat="server" MaxLength="10" autocomplete="off" placeholder="格式:西元年/月/日"></asp:TextBox>
                                                <i class="calendar alternate outline icon"></i>
                                            </div>
                                        </asp:PlaceHolder>
                                        <asp:Literal ID="lt_PostDate" runat="server"></asp:Literal>
                                        <asp:HiddenField ID="hf_PostDate" runat="server" />
                                    </div>
                                    <div class="four wide required field">
                                        <label>郵式</label>
                            ...
                            <div class="ui padded grid">
                                <div class="six wide column">
                                    <a href="<%=fn_Param.WebUrl %><%=Req_Lang %>/<%=Req_RootID %>/Postal/Address" class="ui small button"><i class="user icon"></i>收件資料維護</a>
                                </div>
                                <div class="right aligned ten wide column">
                                    ...
                                    <asp:PlaceHolder ID="ph_Close_Yes" runat="server">
                                        <a class="ui red button"><i class="coffee icon"></i>今日登記已截止</a>
                                    </asp:PlaceHolder>
                ...
                <div class="twelve wide column">
                    ...
                    <asp:PlaceHolder ID="ph_Data" runat="server">
                        <asp:ListView ID="lvDataList" runat="server" ItemPlaceholderID="ph_Items" OnItemDataBound="lvDataList_ItemDataBound">
                            <LayoutTemplate>
                                <table id="tableList" class="ui celled selectable compact small table" style="width: 100%;">
                                    <thead>
                                        <tr>
    ...
    <script>
        $(function () {
            ...
            var myOpt = {
                ...
                minDate: new Date(calToday.getFullYear(), calToday.getMonth(), calToday.getDate()),
                maxDate: new Date(calToday.getFullYear(), calToday.getMonth(), calToday.getDate() + 1)
            };

            $('.datepicker-edit').calendar(myOpt);
