...
public partial class myPostal_SearchClient : SecurityCheck
{
    ...
    protected void lvDataList_ItemDataBound(object sender, ListViewItemEventArgs e)
    {
        try
        {
            if (e.Item.ItemType == ListViewItemType.DataItem)
            {
                ...
                //判斷是否為建立者,顯示編輯鈕
                string _who = DataBinder.Eval(dataItem.DataItem, "Create_Who").ToString();
                string _user = fn_Param.CurrentUser;

                //判斷日期
                DateTime _postDate = Convert.ToDateTime( DataBinder.Eval(dataItem.DataItem, "PostDate"));
                DateTime _today = DateTime.Today;
                bool _showbtn = (_postDate >= _today);

                PlaceHolder ph_Edit = (PlaceHolder)e.Item.FindControl("ph_Edit");
                ph_Edit.Visible = _who.Equals(_user) && _showbtn;
    ...
    private void LookupEditData()
    {
        ...
        try
        {
            ...
            ph_date.Visible = false;
            lt_PostDate.Text = query.PostDate;
            hf_PostDate.Value = query.PostDate;
    ...
    private void Add_Data()
    {
        ...
        try
        {
            ...
            string _postWho = fn_Param.CurrentUserAccount;  //工號
            ...
            //----- 方法:判斷截止(目標日=今日 & 是否關閉) -----
            string st = CheckStatus(_postDate);
            if (st.Equals("Y"))
            {
    ...
    private void Edit_Data()
    {
        ...
        {
            //----- 設定:資料欄位 -----
            string _postDate = hf_PostDate.Value.ToDateString("yyyy/MM/dd");
            string _postWho = fn_Param.CurrentUserAccount;
            string _postType = ddl_PostType.SelectedValue;
            string _weight = tb_PackageWeight.Text;
            string _toWho = tb_ToWho.Text.Trim();
            string _toAddr = tb_ToAddr.Text.Trim();
