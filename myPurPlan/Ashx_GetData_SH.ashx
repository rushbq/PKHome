<%@ WebHandler Language="C#" Class="Ashx_GetData_SH" %>
...
/// <summary>
/// 取得訂貨計劃資料 - SH
/// 使用程式:Search_SH_xx.aspx
/// </summary>
public class Ashx_GetData_SH : IHttpHandler
{
    public void ProcessRequest(HttpContext context)
    {
        ...
        try
        {
            ...
            //----- 方法:取得資料 -----
            var _query = _data.GetPurPlan_SH(_stockType, search, start, length, out DataCnt, out ErrMsg);
