<%@ Page Title="上海訂貨計劃 - 12倉" Language="C#" MasterPageFile="~/Site_S_UI.master" AutoEventWireup="true" CodeFile="Search_SH_12.aspx.cs" Inherits="myPurPlan_SearchByProd" %>
        ...
        <div class="ui small menu toolbar">
            <div class="item">
                <div class="ui small breadcrumb">
                    ...
                    <h5 class="active section red-text text-darken-2">上海訂貨計劃 - 12倉 *** 開發中 ***
                    </h5>
                </div>
            </div>
                ...
                <table id="myListTable" class="ui celled compact small structured table" style="width: 100%">
                    <thead>
                        <tr>
                            ...
                            <th class="grey-bg lighten-3 right aligned numFmt">近N天用量</th>
                            ...
                            <th class="grey-bg lighten-3 right aligned numFmt">擬定數量</th>
                            <th class="grey-bg lighten-3 right aligned numFmt">總擬定數<br />
                                可用周轉月</th>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptContent" runat="Server">
    ...
    <script>
        $(function () {
            ...
            function doSearch() {
                /* 取得資料 - 各欄位 */
                var _stockType = "A"; /* 指定12 (A=12, B=A01, C=合併倉) */
                var _SupID = $("#MainContent_menuSup").dropdown("get value");
                     ...
                     "columns": [
                         ...
                         { data: "StockQty_12", className: "collapsing center aligned" },  /* 庫存<StockQty_12> */
                         {
                             ...
                             data: function (source, type, val) {
                                 ...
                                 var getVal = source.PreIN_12;
                                 //response
                                 var html = getVal == 0 ? "0" : '<a href="#!" class="showPreIn" data-id="' + source.ModelNo + '" data-title="' + source.ModelNo + '" data-stock="12">' + getVal + '</a>';

                                 return html;
                             }, className: "collapsing center aligned"
                         },
                         { data: "VirIn_12", className: "collapsing center aligned" }, /* 虛擬入<VirIn_12> */
                         { data: "PlanIN_12", className: "collapsing center aligned" },    /* 計劃進<PlanIN_12> */
                         { data: "WaitQty", className: "collapsing center aligned" },   /* 待驗收<WaitQty> */
                         { data: "NowMonthTurn_12", className: "collapsing center aligned" },   /* 現有周轉月<NowMonthTurn_12> */
                         {
                             /* 催貨量<PushQty> */
                             data: function (source, type, val) {
                                 var showID = source.RowIdx;
                         ...
                         },
                         {
                             ...
                             data: function (source, type, val) {
                                 var showID = source.RowIdx;
                                 var getVal = source.PreSell_12;
                                 //response
                                 var html = getVal == 0 ? "0" : '<a href="#!" class="showPreSell" data-id="' + source.ModelNo + '" data-title="' + source.ModelNo + '" data-stock="12">' + getVal + '</a>';
                         ...
                         { data: "RealPreSell", className: "collapsing center aligned" },   /* 實際預計銷<RealPreSell> */
                         {
                             ...
                             data: function (source, type, val) {
                                 var showID = source.RowIdx;
                                 var getVal = source.Qty_Days;
                                 //response
                                 var html = getVal == 0 ? "0" : '<a href="#!" class="showInvHistory" data-id="' + source.ModelNo + '" data-title="' + source.ModelNo + '" data-stock="12">' + getVal + '</a>';
                         ...
                         { data: "MonthTurn_12", className: "collapsing center aligned" },   /* 可用週轉月<MonthTurn_12> */
                         { data: "UsefulQty_12", className: "collapsing center aligned" },   /* 可用量<UsefulQty_12> */
                         { data: "SafeQty_12", className: "collapsing center aligned" },   /* 安全存量<SafeQty_12> */
                         { data: "QTM_12", className: "collapsing center aligned" },   /* 擬定數量<QTM_12> */
                         { data: "QTM_Month", className: "collapsing center aligned" },   /* 總擬定數可用周轉月<QTM_Month> */
                         ...
                         { data: "OutBox_Cuft", className: "collapsing center aligned" },   /* 整箱材積<OutBox_Cuft> */
                         {
                             ...
                             data: function (source, type, val) {
                                 var showID = source.RowIdx;
                                 var html = source.Supply_ID + "<br/>" + source.Supplier;
