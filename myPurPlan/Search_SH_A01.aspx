<%@ Page Title="上海訂貨計劃 - A01倉" Language="C#" MasterPageFile="~/Site_S_UI.master" AutoEventWireup="true" CodeFile="Search_SH_A01.aspx.cs" Inherits="myPurPlan_SearchByProd" %>
        ...
        <div class="ui small menu toolbar">
            <div class="item">
                <div class="ui small breadcrumb">
                    ...
                    <h5 class="active section red-text text-darken-2">上海訂貨計劃 - A01倉 *** 開發中 ***
                    </h5>
                </div>
            </div>
                 ...
                 $('#myListTable').DataTable({
                     ...
                     "columns": [
                         ...
                         },
                         {
                             ...
                             data: function (source, type, val) {
                                 var showID = source.RowIdx;
                                 var getVal = source.PreSell_A01;
                                 //response
                                 var html = getVal == 0 ? "0" : '<a href="#!" class="showPreSell" data-id="' + source.ModelNo + '" data-title="' + source.ModelNo + '" data-stock="A01_12">' + getVal + '</a>';
                         ...
                         { data: "QTM_A01", className: "collapsing center aligned" },   /* 擬定數量<QTM_A01> */
