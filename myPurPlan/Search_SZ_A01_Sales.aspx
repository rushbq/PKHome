<%@ Page Title="深圳訂貨計劃(業務版) - A01倉" Language="C#" MasterPageFile="~/Site_S_UI.master" AutoEventWireup="true" CodeFile="Search_SZ_A01_Sales.aspx.cs" Inherits="myPurPlan_Search_SH_A01_Sales" %>
        ...
        <div class="ui small menu toolbar">
            <div class="item">
                <div class="ui small breadcrumb">
                    ...
                    <h5 class="active section red-text text-darken-2">深圳訂貨計劃(業務版) - A01倉
                    </h5>
                </div>
            </div>
            ...
            function doSearch() {
                ...
                table =
                 $('#myListTable').DataTable({
                     ...
                     "serverSide": true,
                     "ajax": {
                         "url": '<%=fn_Param.WebUrl%>' + 'myPurPlan/Ashx_GetData_SZ.ashx?v=1',
                         "type": "POST",
                         "data": {
                             stock: _stockType,
                             ModelNo: _ModelNo,
                     ...
                     "columns": [
                         ...
                         { data: "StockQty_A01", className: "collapsing center aligned" },  /* 庫存<StockQty_A01> */
                         {
                             ...
                             data: function (source, type, val) {
                                 ...
                                 var modelNo = encodeURIComponent(source.ModelNo);
                                 //response
                                 var html = getVal == 0 ? "0" : '<a href="#!" class="showPreIn" data-id="' + modelNo + '" data-title="' + modelNo + '" data-stock="A01">' + getVal + '</a>';
                         ...
                         },
                         {
                             ...
                             data: function (source, type, val) {
                                 ...
                                 var modelNo = encodeURIComponent(source.ModelNo);
                                 //response
                                 var html = getVal == 0 ? "0" : '<a href="#!" class="showPreSell" data-id="' + modelNo + '" data-title="' + modelNo + '" data-stock="A01">' + getVal + '</a>';
                         ...
                         { data: "RealPreSell", className: "collapsing center aligned" },   /* 實際預計銷<RealPreSell> */
                         {
                             ...
                             data: function (source, type, val) {
                                 ...
                                 var modelNo = encodeURIComponent(source.ModelNo);
                                 //response
                                 var html = getVal == 0 ? "0" : '<a href="#!" class="showInvHistory" data-id="' + modelNo + '" data-title="' + modelNo + '" data-stock="A01">' + getVal + '</a>';
