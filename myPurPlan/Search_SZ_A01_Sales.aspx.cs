...
public partial class myPurPlan_Search_SH_A01_Sales : SecurityCheck
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                //[權限判斷] Start
                #region --權限--
                bool isPass = fn_CheckAuth.Check(fn_Param.CurrentUser, "4209");
    ...
    protected void btn_Excel_Click(object sender, EventArgs e)
    {
        ...
        //----- 方法:取得資料 -----
        var _rowData = _data.GetPurPlan_SZ(_stockType, search, 0, 99999, out DataCnt, out ErrMsg);
        ...
        CustomExtension.ExportExcel(
            newDT
            , "ExcelData-SZ-{0}.xlsx".FormatThis(DateTime.Now.ToShortDateString().ToDateString("yyyyMMdd"))
            , false);
    }
    ...
    public string Req_CompID
    {
        get
        {
            ...
            return DataID.ToLower().Equals("") ? "SZ" : DataID;
        }
        set
        {
