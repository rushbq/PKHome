                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="center aligned collapsing">
                                                <a class="ui small teal basic icon button" href="<%=fn_Param.WebUrl%>myShipping/ShipComp.aspx?comp=<%=Req_CompID %>&id=<%#Eval("ID") %>&back=<%=Server.UrlEncode(prevPage) %>">
