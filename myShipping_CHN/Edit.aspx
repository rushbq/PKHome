...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
                        ...
                        <div class="row">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="center aligned">
                                                <strong class="ui basic label"><%#fn_Menu.GetItem_ShipFrieghtWay(Eval("FreightWay").ToString()) %></strong>
                                            </td>
                                            <td class="center aligned">
                                                <input id="Pay<%#Eval("Data_ID") %>" type="number" maxlength="8" value="<%#Eval("Freight") %>" min="0" step="any" />
                                            </td>
                                            <td class="center aligned">
                            ...
                            <div class="six wide column">
                                <div class="fields">
                                    <div class="four wide field">
                                        <label>運費方式</label>
                                        <asp:DropDownList ID="ddl_FreightWay" runat="server" CssClass="fluid">
                                    ...
                                    <div class="four wide field">
                                        <label>運費</label>
                                        <asp:TextBox ID="tb_Freight" runat="server" MaxLength="8" placeholder="輸入數字" autocomplete="off" type="number" min="0" step="any">0</asp:TextBox>
                                    </div>
                                    <div class="four wide field">
                                        <label>件數</label>
    ...
    <div id="confirmPage" class="ui small modal">
        ...
        <div class="actions">
            ...
            <a class="ui positive right labeled icon button" href="<%=fn_Param.WebUrl %>myShipping_CHN/ShipComp.aspx?dt=<%=Req_DataType %>&back=<%=Server.UrlEncode(thisPage) %>">繼續前往<i class="chevron right icon"></i>
            </a>
        </div>
    </div>
    <!-- 貨運維護詢問框 End -->
...
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptContent" runat="Server">
    ...
    <script>
        $(function () {
            ...
            $(".btn-ShipNoSave").click(function () {
                ...
                var request = $.ajax({
                    url: '<%=fn_Param.WebUrl%>' + "myShipping_CHN/Ashx_UpdateShipNo.ashx",
                    method: "POST",
                    data: {
                        ParentID: _ParentID,
                        DataID: _DataID,
    ...
    <script>
        ...
        $('.ac-ErpNo').search({
            ...
            , apiSettings: {
                url: '<%=fn_Param.WebUrl%>myShipping_CHN/GetData_ErpSno.ashx?q={query}&custID=' + pubCustID + '&dt=' + pubType
            }
    ...
    <script>
        ...
        $('.ac-ShipComp').search({
            ...
            , apiSettings: {
                url: '<%=fn_Param.WebUrl%>myShipping_CHN/GetData_ShipComp.ashx?q={query}&v=<%=Req_ErpNo%>'
            }
