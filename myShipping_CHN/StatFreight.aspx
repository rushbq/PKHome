                    ...
                    <tr class="<%#setBg(Eval("Month")) %>">
                        <td class="center aligned">
                            <strong class="green-text text-darken-3">
                                <a href="<%:fn_Param.WebUrl %><%:Req_Lang %>/3000/ShipFreightSend_CHN?dt=<%=Req_DataType %>&tab=2&sDate_Ship=<%#Server.UrlEncode(Eval("sDate").ToString()) %>&eDate_Ship=<%#Server.UrlEncode(Eval("eDate").ToString()) %>">
                                    <%#Eval("showYM") %>
                                </a>
                            </strong>
                        </td>
