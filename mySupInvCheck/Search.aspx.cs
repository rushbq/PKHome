...
public partial class mySupInvCheck_Search : SecurityCheck
{
    ...
    private void LookupDataList(int pageIndex)
    {
        ...
        //----- 原始資料:取得所有資料 -----
        var query = _data.GetSupInvReplyList(search, StartRow, RecordsPerPage
        ...
        if (query.Count() == 0)
        {
            ...
            //Clear
            CustomExtension.setCookie("SupInvCheckB", "", -1);
        }
        else
        {
            ...
            //暫存頁面Url, 給其他頁使用
            CustomExtension.setCookie("SupInvCheckB", Server.UrlEncode(reSetPage), 1);
